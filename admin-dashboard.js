...
async function loadAdminSession() {
  try {
    ...
    await Promise.all([loadDashboardData(), renderProducts(), loadOrders(), loadContacts(), loadInitiations(), loadJoins()]);
  } catch (error) {
...
function attachDashboardEvents() {
  document.getElementById('refreshButton')?.addEventListener('click', () => Promise.all([loadDashboardData(), renderProducts(), loadOrders(), loadContacts(), loadInitiations(), loadJoins()]));
